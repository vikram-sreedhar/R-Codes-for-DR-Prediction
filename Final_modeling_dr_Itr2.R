...
# Denoising the images using Median filter

for (i in c(901:950,1801:1850,2701:2750,3601:3650,4501:4550,5401:5450,6301:6350,7201:7250,8101:8150,9001:9050,10951:11000,11851:11900,12751:12800,13651:13700,14551:14600,15551:15600,16451:16500,17351:17400,18251:18300,19151:19200,20051:20100,21901:21950,22801:22850,23701:23750,24651:24700,25975:26025))  {images_0[[i]] <- EBImage::medianFilter(images_0[[i]],1)}
...
for (i in c(501:550,851:900,1235:1284,1915:1964,2051:2100,2975:3024,3445:3494,4225:4274,4995:5044,5265:5314,5885:5934,6025:6074,6985:7034,7601:7650,8001:8050,8565:8614,9375:9424,9775:9824,10155:10204,10665:10714,11155:11204))  {images_1[[i]] <- EBImage::medianFilter(images_1[[i]],1)}
...
for (i in c(501:550,851:900,1235:1284,1915:1964,2051:2100,2975:3024,3445:3494,4225:4274,4995:5044,5265:5314,5885:5934,6025:6074,6985:7034,7601:7650,8001:8050,8565:8614,9375:9424,9775:9824,10155:10204,10665:10714,11155:11204))  {images_2[[i]] <- EBImage::medianFilter(images_2[[i]],1)}
...
for (i in c(501:550,851:900,1235:1334,1915:1964,2051:2150,2975:3024,3445:3544,4225:4274,4995:5044,5265:5314,5885:5934,6025:6074,6985:7034,7601:7650,8001:8050,8465:8514))   {images_3[[i]] <- EBImage::medianFilter(images_3[[i]],1)}
...
for (i in c(501:625,851:900,1235:1284,1915:1964,2051:2150,2975:3024,3445:3544,4225:4274,4995:5044,5265:5314,5885:5934,6025:6074,6985:7034,7601:7650,8001:8025))  {images_4[[i]] <- EBImage::medianFilter(images_4[[i]],1)}
...
# 0.0000  0.5020  0.5358  0.5434  0.5787  1.0000   
...
for (i in c(4501:4550,5401:5450))  {images_test_0[[i]] <- EBImage::medianFilter(images_test_0[[i]],1)}
for (i in c(10155:10204,10665:10714))  {images_test_1[[i]] <- EBImage::medianFilter(images_test_1[[i]],1)}
for (i in c(4225:4274,4995:5044))  {images_test_2[[i]] <- EBImage::medianFilter(images_test_2[[i]],1)}
for (i in c(6985:7034,7601:7650))  {images_test_3[[i]] <- EBImage::medianFilter(images_test_3[[i]],1)}
for (i in c(4995:5044,5265:5314))  {images_test_4[[i]] <- EBImage::medianFilter(images_test_4[[i]],1)}
...
summary(Test_fin_x)
#  Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
# 0.0007782 0.5019608 0.5322194 0.5410621 0.5737087 1.0000000   
...
history <- model %>%
  fit(Train_fin_x,
      ...
      batch_size = 32,
      validation_data = list(Test_fin_x, TestLabels),
      callbacks = callback_tensorboard('ctg_final_1/one'))
...
for (i in 19501:19550)  {images_ind_0[[i]] <- EBImage::medianFilter(images_ind_0[[i]],1)}
for (i in 5701:5750)  {images_ind_1[[i]] <- EBImage::medianFilter(images_ind_1[[i]],1)}
for (i in 6601:6650)  {images_ind_2[[i]] <- EBImage::medianFilter(images_ind_2[[i]],1)}
for (i in 7201:7250)  {images_ind_3[[i]] <- EBImage::medianFilter(images_ind_3[[i]],1)}
for (i in 4401:4450)  {images_ind_4[[i]] <- EBImage::medianFilter(images_ind_4[[i]],1)}
...
# Predicting the model results with principal components on Test data
...
writeImage(real_images,"real_images.jpg",quality = 100)
writeImage(combined_images,"combined_images.jpg",quality = 100)
